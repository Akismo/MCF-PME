...
<head>
    ...
    <title>@yield('title', 'Espace Membre MCF-PME')</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('membre_dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('membre_nouvelle_demande') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('membre_demandes') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('membre_profile') }}">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    {{ Auth::guard('membre')->check() ? Auth::guard('membre')->user()->name . ' ' . Auth::guard('membre')->user()->prenom : 'Membre' }}
                                </span>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ route('membre_logout') }}" method="POST" class="modal-content">
                @csrf
