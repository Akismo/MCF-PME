...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-between bg-blue-600 p-4 text-white">
        <h1 class="text-xl font-bold">Bienvenue, {{ Auth::guard('administrateur')->user()->name }}</h1>
        <form action="{{ route('administrateur_logout') }}" method="POST">
            @csrf
    ...
    <div class="p-8">
        ...
        <p>Bienvenue sur votre tableau de bord. Vous êtes connecté en tant qu'administrateur.</p>
