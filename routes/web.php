...
use App\Http\Controllers\ComiteCreditController;
...
Route::prefix('administrateur')->group(function () {
    ...
    Route::middleware(['administrateur'])->group(function () {
        ...
        // Route pour le CAF 
        Route::get('/caf/dashboard', [CafController::class, 'dashboard'])->name('dashboard.caf');
        Route::get('/caf', [CafController::class, 'index'])->name('caf.index');
        Route::get('/caf/filter', [CafController::class, 'filter'])->name('caf.filter');
        Route::get('/caf/{demande}', [CafController::class, 'show'])->name('caf.show');
        Route::post('/caf/{demande}/verify', [CafController::class, 'verify'])->name('caf.verify');

        // Route pour le Comité de crédit

        Route::get('/comite-credit', [ComiteCreditController::class, 'index'])->name('comite-credit.index');
        Route::get('/comite-credit/dashboard', [ComiteCreditController::class, 'dashboard'])->name('comite-credit.dashboard');
        Route::get('/comite-credit/{demande}', [ComiteCreditController::class, 'show'])->name('comite-credit.show');
        Route::post('/comite-credit/{demande}/annotate', [ComiteCreditController::class, 'annotate'])->name('comite-credit.annotate');
        Route::post('/comite-credit/{demande}/decide', [ComiteCreditController::class, 'decide'])->name('comite-credit.decide');
